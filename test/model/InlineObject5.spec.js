...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerTynidesigner.InlineObject5();
  });
  ...
  describe('InlineObject5', function() {
    it('should create an instance of InlineObject5', function() {
      ...
      //var instane = new SwaggerTynidesigner.InlineObject5();
      //expect(instance).to.be.a(SwaggerTynidesigner.InlineObject5);
    });
