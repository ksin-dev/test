...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerTynidesigner.Pagination1();
  });
  ...
  describe('Pagination1', function() {
    it('should create an instance of Pagination1', function() {
      // uncomment below and update the code to test Pagination1
      //var instane = new SwaggerTynidesigner.Pagination1();
      //expect(instance).to.be.a(SwaggerTynidesigner.Pagination1);
    });
